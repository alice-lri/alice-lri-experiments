...
CREATE TABLE local_geometry_experiment
(
    id integer PRIMARY KEY AUTOINCREMENT,
    timestamp text NOT NULL,
    label text NOT NULL,
...
CREATE TABLE local_geometry_frame_result
(
    id integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
CREATE INDEX local_geometry_frame_result_experiment_id_idx ON local_geometry_frame_result (experiment_id);
CREATE INDEX local_geometry_frame_result_experiment_id_dataset_frame_id_idx ON local_geometry_frame_result (experiment_id, dataset_frame_id);
