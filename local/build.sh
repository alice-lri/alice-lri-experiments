...
cmake -DCMAKE_BUILD_TYPE=Release -DLOG_LEVEL=INFO -DENABLE_TRACE_FILE=OFF -DENABLE_PROFILING=OFF -DLIB_MODE=ON $BUILD_OPTIONS -S "${ACCURATE_RI_SRC}" -B "${ACCURATE_RI_SRC}/build"
